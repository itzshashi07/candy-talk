...
import GlobalResultSmall from "./GlobalResultSmall";

const GlobalSearchSmall = () => {
  ...
  return (
    <div className="shadow-md rounded-xl hidden sm:block sm:max-w-[450px] max-sm:block max-sm:max-w-[450px] md:hidden md:max-w-[0px] relative w-full max-w-[220px]">
      ...
      {isOpen && <GlobalResultSmall searchText={search} />}
    </div>
  );
};

export default GlobalSearchSmall;
